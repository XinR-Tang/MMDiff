"""IR image generation guided by OPT attention/resnet features.

This script loads the IR LoRA adapter on top of the shared stable-diffusion
...
def main():
    cfg = SamplingConfig()
    set_seed(cfg.seed)
    output_path = os.path.join(cfg.output_dir, "ir")
    ...
    # Load IR LoRA weights.
    unet.load_attn_procs(cfg.ir_lora_path)
